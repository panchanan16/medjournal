...
export default function NewsForm({ initialValues }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await _POST(`news/${editId ? `update?news_id=${editId}` : 'create'}`, formData, `${editId ? 'PUT' : 'POST'}`);
  ...
  return (
    <div className="max-w-4xl mx-auto my-8 p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-2xl font-bold text-red-700 mb-6">Add a News</h1>
