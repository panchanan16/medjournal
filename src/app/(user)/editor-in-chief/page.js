...
export default async function EditorChiefPage() {
    const editorData = await _GET(`editorBoard/readAll?editor_type=editor in chief`)
                    ...
                    editorData?.map((chief, key) => (
                        <div className="bg-white rounded-lg shadow-md overflow-hidden" key={key}>
                            ...
                            <div className="bg-gradient-to-r from-red-700 to-red-900 px-6 py-8 text-white">
                                <h1 className="text-3xl font-bold mb-1">{chief.name}</h1>
                                <div className="text-xl text-red-100 font-semibold">{chief.editor_type.toUpperCase()}</div>
                                <div className="text-xl text-red-100">{chief.designation}</div>
                            </div>
                                ...
                                <div className="flex flex-col md:flex-row gap-8">
                                        ...
                                        <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                                            ...
                                            <div className="p-4 border-t border-gray-200 bg-gray-50">
                                                <div className="mb-3">
                                                    ...
                                                    <p className="text-gray-800">{chief.institution}</p>
                                                </div>
                                                <div className="mb-3">
                                                    <h3 className="text-sm font-semibold text-gray-500 uppercase mb-1">Qualification</h3>
                                                    <a href={`mailto:${chief.email}`} className="text-red-60 hover:text-red-800 transition-colors">
                                                        {chief.qualification}
                                                    </a>
                                                </div>
                                    ...
                                    <div className="md:w-2/3">
                                        <div className="mb-4">
                                            ...
                                            {chief.biography ? (
                                                <div className="space-y-4 text-gray-700" dangerouslySetInnerHTML={{ __html: chief.biography }}>
