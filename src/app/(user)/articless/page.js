...
export default function ArticlePage() {
  ...
  const articleData = {
    ...
    affiliations: [
      { id: '1', text: 'Department of Clinical Laboratory, Benxi Iron and Steel General Hospital, Benxi, China' },
      { id: '2', text: 'Department of Surgery II, Witten/Herdecke University, Witten, Germany' },
      { id: '3', text: 'Division of Gastroenterology, NYU Grossman School of Medicine, New York, NY, USA' }
    ],
    correspondence: 'Jian Zhang, MS. Department of Clinical Laboratory, Benxi Iron and Steel General Hospital, No. 29, Renmin Road, Benxi 117017, China.',
    contributions: [
    ...
    metrics: {
      pdf: 298,
      fullText: 530,
      reportingChecklist: 64,
      peerReviewFile: 63,
      coiForm: 68
    },
    citationFormats: ['Bibtex', 'EndNote', 'ProCite', 'refMan', 'refWorks']
  };
            ...
            <article className="lg:w-3/4 bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div className="mb-6 border-b">
                <div className="flex flex-wrap">
                  <button 
                    className={`px-4 py-2 font-medium ${activeTab === 'article' ? 'text-red-700 border-b-2 border-red-700' : 'text-gray-600 hover:text-red-700'}`}
                    onClick={() => setActiveTab('article')}
                  >
                    Article
                  </button>
                  <button 
                    className={`px-4 py-2 font-medium ${activeTab === 'figures' ? 'text-red-700 border-b-2 border-red-700' : 'text-gray-600 hover:text-red-700'}`}
                    onClick={() => setActiveTab('figures')}
                  >
                    Figures
                  </button>
                  <button 
                    className={`px-4 py-2 font-medium ${activeTab === 'tables' ? 'text-red-700 border-b-2 border-red-700' : 'text-gray-600 hover:text-red-700'}`}
              ...
              {activeTab === 'figures' && (
                <div className="text-center py-8 text-gray-500">
                  Figures section content would display here
                </div>
              )}
              
              {activeTab === 'tables' && (
                <div className="text-center py-8 text-gray-500">
                  Tables section content would display here
                </div>
              )}
            </article>
